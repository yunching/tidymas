...
#BoE stopped publishing 
#g4 <- ggTS("CEERUKEN Index", title = "BoE Narrow FX index")
...
grid.arrange(wti, gold, corn, brent, silver, wheat, nrow = 2)
```
#Select Equities
...
grid.arrange(nvda, intc, tsla, msft, csco, ibm, ncol = 3)
```
...
threei <- ggTS("3IN LN Equity", title = "3i")
grid.arrange(bs, kkr, apo, cg, oak, threei, nrow = 2)
```
