...
all.equal(TTR::EMA(x, 20), ema(x, 20))
microbenchmark(TTR::EMA(x, 20), ema(x, 20))

all.equal(TTR::RSI(x, 20), rsi(x, 20))
microbenchmark(TTR::RSI(x, 20), rsi(x, 20))

all.equal(TTR::stoch(x, smooth = 1), stoc(x) / 100)
microbenchmark(TTR::stoch(x, smooth = 1), stoc(x))
all.equal(TTR::stoch(x, smooth = 3), stoc(x, smooth.k = 3) / 100)
