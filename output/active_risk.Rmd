...
unwt_ret_roll <- apply(remove_date(unwt_returns$sim), 2, roll_sum, n = window) %>% as.data.frame
unwt_ret_roll <- cbind(data.frame(date = unwt_returns$sim$date[-(1:(window-1))]), unwt_ret_roll)

sim_ret_roll <- apply(remove_date(wt_returns$sim), 2, roll_sum, n = window) %>% as.data.frame
