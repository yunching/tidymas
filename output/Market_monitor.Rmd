...
country_factors <- rev(c("Germany", "France",  "Italy", "Spain", "Portugal", "United Kingdom"))
...
eur_yields %>% 
  ...
  ggplot(aes(x = Tenor, y = Country, fill = Yield)) + geom_tile() + geom_text(aes(label = Yield)) + scale_fill_gradient2(low = "red", mid = "white", high = "green")
```
